...
class HalfByteGridTest {
    ...
    void testCreateGridVec2i() {
        HalfByteGrid halfByteGrid = new HalfByteGrid();
        halfByteGrid.createGrid(new Vec2i(10, 10));
        
        char[][] cells = halfByteGrid.getCells();
        assertEquals(10, cells.length);
        assertEquals(5, cells[0].length);

        halfByteGrid.createGrid(new Vec2i(11, 11));
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            halfByteGrid.createGrid(new Vec2i(-11, 12));
        });
    ...
    void testSetAndGetCellVec2i() {
        HalfByteGrid halfByteGrid = new HalfByteGrid();
        halfByteGrid.createGrid(new Vec2i(10, 8));

        assertThrows(IndexOutOfBoundsException.class, () -> {
            halfByteGrid.getCell(new Vec2i(10, 7));
        });


        assertThrows(IndexOutOfBoundsException.class, () -> {
            halfByteGrid.getCell(new Vec2i(9, 8));
        });

        assertThrows(IndexOutOfBoundsException.class, () -> {
            halfByteGrid.getCell(new Vec2i(-1, 7));
        });

        assertThrows(IndexOutOfBoundsException.class, () -> {
            halfByteGrid.getCell(new Vec2i(9, -1));
        });

        assertDoesNotThrow(() -> {
            halfByteGrid.getCell(new Vec2i(0, 0));
        });

        assertDoesNotThrow(() -> {
            halfByteGrid.getCell(new Vec2i(9, 7));
        });

        for(int y = 0; y < halfByteGrid.getSize().y; ++y) {
            for (int x = 0; x < halfByteGrid.getSize().x * 2; ++x) {
                assertEquals(0, halfByteGrid.getCell(new Vec2i(x, y)));
            }
        }
        ...
        assertDoesNotThrow(() -> {
            for (int y = 0; y < halfByteGrid.getSize().y; ++y) {
                for (int x = 0; x < halfByteGrid.getSize().x * 2; ++x) {
                    if (y % 3 == 0 && x % 4 == 0) {
                        halfByteGrid.setCell(new Vec2i(x, y), 8);
                    } else if (y % 2 == 0 && x % 2 == 0) {
                        halfByteGrid.setCell(new Vec2i(x, y), 16);
                    }
                }
            }
        });
        ...
        for (int y = 0; y < halfByteGrid.getSize().y; ++y) {
            for (int x = 0; x < halfByteGrid.getSize().x * 2; ++x) {
                if (y % 3 == 0 && x % 4 == 0) {
                    assertEquals(8, halfByteGrid.getCell(new Vec2i(x, y)));
                } else if (y % 2 == 0 && x % 2 == 0) {
                    assertEquals(0, halfByteGrid.getCell(new Vec2i(x, y)));
                } else {
                     assertEquals(0, halfByteGrid.getCell(new Vec2i(x, y)));
        ...
        assertThrows(IndexOutOfBoundsException.class, () -> {
            halfByteGrid.getCell(new Vec2i(12, 7));
        });

        assertThrows(IndexOutOfBoundsException.class, () -> {
            halfByteGrid.getCell(new Vec2i(11, 8));
        });
        ...
        assertThrows(IndexOutOfBoundsException.class, () -> {
            halfByteGrid.getCell(new Vec2i(11, -1));
        });
        ...
        assertDoesNotThrow(() -> {
            halfByteGrid.getCell(new Vec2i(11, 7));
        });
    ...
    void clear() {
        ...
        assertNotEquals(new Vec2i(0, 0), halfByteGrid.getSize());
        halfByteGrid.clear();
